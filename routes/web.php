...
Route::get('/absensi', [HomeController::class, 'absensi'])->middleware(['auth','XSS'])->name('absensi');
Route::get('/daily', [DailyController::class, 'index'])->middleware(['auth','XSS'])->name('daily');
Route::get('/daily/create', [DailyController::class, 'create'])->middleware(['auth','XSS'])->name('daily.create');
Route::post('/daily/insertdata', [DailyController::class, 'insertdata'])->middleware(['auth','XSS'])->name('insertdata');
