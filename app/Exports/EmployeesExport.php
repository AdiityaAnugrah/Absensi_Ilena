    ...
    */
    public function collection()
    {
        ...
        foreach($data as $k => $employees)
        {
            ...
            $data[$k]["branch_id"]=Branch::where('id',$employees->branch_id)->pluck('name')->first();
            $data[$k]["department_id"]=Department::where('id',$employees->department_id)->pluck('name')->first();
            $data[$k]["designation_id"]= Designation::where('id',$employees->designation_id)->pluck('name')->first();
