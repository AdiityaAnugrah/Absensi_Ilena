...
<?php $__env->startSection('action-button'); ?>
    <a href="<?php echo e(route('attendance.export')); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $attendanceEmployee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><iframe src='https://www.google.com/maps?q=<?php echo $attendance["latitude"];?>,<?php echo $attendance["longitude"];?>&hl=es;z=14&output=embed' style ="width: 300px; height: 300px;"></iframe></td>
                                    <td class="Action">
                                        <?php if(Gate::check('Edit Attendance') || Gate::check('Delete Attendance')): ?>
                                            <span>
